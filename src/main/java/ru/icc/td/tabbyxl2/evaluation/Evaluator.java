...
package ru.icc.td.tabbyxl2.evaluation;
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (File resultExcelFile : listOfExcelFiles) {
            if (resultExcelFile.isFile()) {
                ...
                String gtDirectoryPath = groundTruthDirectory.getAbsolutePath();
                String resultExcelFileName = resultExcelFile.getName();
                File gtExcelFile = Paths.get(gtDirectoryPath, resultExcelFileName).toFile();
