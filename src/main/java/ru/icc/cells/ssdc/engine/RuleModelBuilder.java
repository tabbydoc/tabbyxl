...
public class RuleModelBuilder {
    ...
    private Condition buildCondition(int id, Tree subTree)
    {
        ...
        switch (subTree.getChild(0).getText()) {
            case "cell": condition.setType("condition"); condition.setVariable(new Variable("CCell", subTree.getChild(1).getText()));
                break;
            case "label": condition.setType("condition"); condition.setVariable(new Variable("CLabel", subTree.getChild(1).getText()));
                break;
            case "entry": condition.setType("condition"); condition.setVariable(new Variable("CEntry", subTree.getChild(1).getText()));
                break;
            case "category": condition.setType("condition"); condition.setVariable(new Variable("Category", subTree.getChild(1).getText()));
                break;
            case "no cells": condition.setType("no_condition"); condition.setVariable(new Variable("CCell", "$id"+condition.getId()));
                break;
            case "no labels": condition.setType("no_condition"); condition.setVariable(new Variable("CLabel", "$id"+condition.getId()));
                break;
            case "no entries": condition.setType("no_condition"); condition.setVariable(new Variable("CEntry", "$id"+condition.getId()));
                break;
            case "no categories": condition.setType("no_condition"); condition.setVariable(new Variable("CCategory", "$id"+condition.getId()));
                break;
